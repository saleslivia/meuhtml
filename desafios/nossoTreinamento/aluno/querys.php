...
function listaAluno($conexao){
    ...
    while ($aluno=mysqli_fetch_assoc($resultado)){ //enquanto tiver item na lista, ele vai jogar no array
        array_push($todosAlunos, $aluno); //de onde vem a informação e o que está sendo guardado
    }
    return $todosAlunos;
}
