    ...
    <form action="form_calculadora.php" method="get">
        <fieldset>
            ...
            <select name="operacoes" id="iOperacoes"  required>
                ...
                <option value="dobro" disabled>Dobro</option>
                <option value="cubo" disabled>Cubo</option>
                <option value="raiz" disabled>Raiz quadrada</option>
                ...
                <option value="fatorial" disabled>Fatorial</option>
            </select>
            <br><br>
